 ...
 * @OA\GET(
 *     path="/api/evenements/{evenement_id}",
 *     summary="show",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 ...
 * @OA\Response(response="404", description="Not Found"),
 * @OA\Response(response="500", description="Internal Server Error"),
 *     @OA\Parameter(in="path", name="evenement_id", required=false, @OA\Schema(type="string")
 * ),
 *     @OA\Parameter(in="header", name="User-Agent", required=false, @OA\Schema(type="string")
 * ),
 *     tags={"Gestion Evenement"},
...
*/
 ...
 class GestionEvenementAnnotationController {}
